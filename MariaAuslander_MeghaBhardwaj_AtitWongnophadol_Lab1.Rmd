...
And as shown in the paper, the estimated shapes of the probability of failure between both the binomial and binary logistic models were close to each other. So this is an evidence that O.ring failure was probably independent of each other.
