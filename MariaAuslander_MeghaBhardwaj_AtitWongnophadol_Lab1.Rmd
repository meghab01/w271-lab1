...
We will evaluate the odds ration of O-ring failure for a 10 degree increase in temperature. For a 10 degree increate in temperature, the odds ratio of O.ring failure changes by 0.3
...
Model Summary
In conclusion, we see evidence for the effect of temperature on O.ring failure. At lower temperatures, the probability of O.ring failure is significantly lower. In our model interpretation, we saw that reducing temperature from 80 degrees to 31 degress increases the probability of failure by 96%
